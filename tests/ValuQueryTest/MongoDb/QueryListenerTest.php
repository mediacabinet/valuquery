...
class QueryListenerTest extends TestCase
{
    ...
    public function testApplyAttributeSelectorInList()
    {
        ...
        $this->assertEquals(['query' => ['hobbies' => ['$in' => ['sailing', 'chilling', 'relaxing']]]],
    ...
    public function testApplyAttributeSelectorRegExp()
    {
        ...
        $this->assertEquals(['query' => ['name' => ['$regex' => 'john.*smith']]],
            $this->applyAttributeSelector($selector));
    }
    ...
    public function testApplyAttributeSelectorRegExpUsingInlineCaseInsensitiveModifier()
    {
        ...
        $this->assertEquals(['query' => ['name' => ['$regex' => 'john.*smith', '$options' => 'i']]],
            $this->applyAttributeSelector($selector));
    }
    ...
    public function testApplyAttributeSelectorRegExpUsingAllInlineModifiers()
    {
        ...
        $this->assertEquals(['query' => ['name' => ['$regex' => 'john.*smith', '$options' => 'imxs']]],
            $this->applyAttributeSelector($selector));
    }
    ...
    public function testApplyAttributeSelectorSubstrMatch()
    {
        ...
        $this->assertEquals(['query' => ['ip' => ['$regex' => ".*\\.221\\..*"]]],
            $this->applyAttributeSelector($selector));
    }
    ...
    public function testApplyAttributeSelectorNotPrefixMatch()
    {
        $selector = new Attribute('ip', Attribute::OPERATOR_NOT_SUBSTR_PREFIX, '168.');
        $this->assertEquals(['query' => ['ip' => ['$regex' => "^(?!168\\.)"]]],
            $this->applyAttributeSelector($selector));
    }
    ...
    public function testApplyAttributeSelectorNotSuffixMatch()
    {
        $selector = new Attribute('ip', Attribute::OPERATOR_NOT_SUBSTR_SUFFIX, '.2');
        $this->assertEquals(['query' => ['ip' => ['$regex' => "(?!\\.2)$"]]], $this->applyAttributeSelector($selector));
    }
